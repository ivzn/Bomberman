...
public class MainMenu1 extends JFrame {
	...
	public MainMenu1 (int screenType) 
	{
		...
		// game
			...
			frame = new GridMap(settingLevel, settingTime).getGridMapFrame();
			frame.pack();
	...
	public void displayMainMenu()
	{
		...
		screen.setBackground(new Color(25,200,255));
		...
		ImageIcon gifIcon = new ImageIcon("bomberman.gif");
		gif = new JLabel(gifIcon);
		screen.add(gif);
		gif.setBounds(300, 100,100,100);
